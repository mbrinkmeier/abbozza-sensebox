...
Abbozza.SenseBoxRV8523Device = {
    ...
    generateCode: function (generator) {
        ...
        generator.addSetupCode("__RV8523_" + this.getName() + ".begin();");
        generator.addSetupCode("__RV8523_" + this.getName() + ".setTime(__DATE__,__TIME__);");
        var code = "RV8523 __RV8523_" + this.getName() + ";";
...
init: function() {
  ...
  generateCode: function(generator) {
 	...
 	if ( device == null ) {
        ...
        code = "__RV8523_" + device.getName() + "." + choice + "()";
...
init: function() {
  ...
  generateCode: function(generator) {
 	...
 	if ( device == null ) {
        ...
        code = "__RV8523_" + device.getName() + ".set(" + code + ");";
